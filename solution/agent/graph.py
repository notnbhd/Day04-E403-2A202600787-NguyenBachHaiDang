...
If ANY of these is missing → ask for the missing field(s) in Vietnamese. Do NOT call any tool.
Examples of CASE B:
  - "Tạo đơn 2 Dell UltraSharp cho công ty mới" → missing name, phone, email, address → CASE B
  - "Tạo đơn cho Thu Hà, SĐT 0905123456, giao 120 Cộng Hòa. Cần 1 Dell Inspiron 14" → missing email → CASE B
